	...
	<main class="DashboardMain">
		...
		<section>
			<fieldset class="DashboardMain-fieldset" style="width: 100%; border-radius: 20px; border: 1px solid #BFBFBF; border-radius: 24px; padding: 7%;">
				<form class="SignupForm" role="form" method="post" name="search">
					<label for="doctorname">Search by Name/Mobile No.</label>
					<input type="text" name="searchdata" id="searchdata" value="" required='true'>
					<button type="submit" id="submit" name="search" class="updatebtn">Search</button>
				</form>
			</fieldset>
		</section>
		<section>
			...
			<thead>
				<tr align="center">
					<th colspan="8" align="center" style="font-size:20px;color: #212529">Result against "<?php echo $sdata;?>" keyword </th>
				</tr>
				<tr>
					<th class="center">#</th>
					<th>Patient Name</th>
